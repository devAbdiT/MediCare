      ...
      <aside className="w-[280px] bg-white dark:bg-[#111C3A] border border-[#D0DCE8] dark:border-[#1A2A4A] flex flex-col rounded-[2.5rem] shadow-sm transition-all duration-500 shrink-0">
        <div className="p-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-xl font-black tracking-tighter block leading-none text-[#1A2A4A] dark:text-[#E8EEF8]">MediCare</span>
              <span className="text-[10px] font-bold text-[#5A6E8A] dark:text-[#8A9CBA] uppercase tracking-[0.3em] mt-1 block">Cloud OS</span>
            </div>
          </div>
        </div>

        <nav className="flex-1 px-6 space-y-2 mt-4 overflow-y-auto custom-scrollbar">
          <p className="text-[10px] font-black text-[#5A6E8A] dark:text-[#8A9CBA] uppercase tracking-widest px-4 mb-4">Main Menu</p>
        ...
        <div className="p-8 mx-4 mb-6 bg-[#F0F4F8] dark:bg-[#0A122A] rounded-[2rem] border border-[#D0DCE8] dark:border-[#1A2A4A]">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs font-black truncate text-[#1A2A4A] dark:text-[#E8EEF8]">{session?.user?.name}</p>
              <p className="text-[9px] font-black text-[#1E4A8A] dark:text-[#4A8AC8] uppercase tracking-widest mt-0.5">{role}</p>
            </div>
          </div>
          <button
